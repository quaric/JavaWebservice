...
/*
 * Denne klassen sjekker først om brukernavn og passord stemmer
 * Dersom det ikke stemmer så blir forsøket lagret i failedLogins arraylisten,
 * Dersom du har feilaktig logget inn mer enn 2 ganger så må tjenesten restartes
 * Ved vellykket forsøk bygger den en streng med brukernavn, epost og fullt navn som returneres til klienten.
 */
...
public class UserChecker {
	...
	public String getResult() {
		...
		try {
			...
			result.append("CommunicationException. Koble til internett og VPN for å få adgang.");
		}
		catch(Exception e) { 
