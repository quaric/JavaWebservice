...
public class MainService {
	...
	/*
	 * denne teller bare lengden på bytearrayet og returnerer det.
	 */
	public int getByteCount(byte[] bytes) {
		return bytes.length;
		
		/*
		 * Min første ide var å bruke JAXB til å hente størrelsen, men jeg fikk bare feil størrelser.
		 * Metoden jeg brukte da var å serialisere objektet først i C# med XMLSerializer, og deserialisere det med JAXB.
		 * En String på 3 bytes ble til 1703 bytes f.eks, så jeg droppet den ideen da jeg ikke fikk tid.
		 */
	...
	/*
	 * Brukes ikke, men kan brukes til å sjekke bytecount på floatnummer
	 */
	/*
	...
	/*
	 * Brukes til å sjekke brukernavn og passord på UiT sin AD,
	...
	/*
	 * Brukes til å hente QRBilde, som blir returnert som et byte array
	 */
